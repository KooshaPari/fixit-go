...
<main>
	...
	<div id="body">
		...
		>
			...
			<div
				style="padding:0.25em; background-color:#112f39; box-sizing: content-box; width: 100%; height: 100%; position: sticky; top: 0;"
			>
				<button
					on:click={() => {
			...
			<div
				id="todoList"
				style="background-color:#213f49; width: 100%; box-sizing:content-box; 100%; padding: 1em; padding-bottom: 20%; border-radius: 2em 2em 2em 2em;"
			>
				<ul id="todos">
